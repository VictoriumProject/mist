...
!define GROUPNAME "Victorium"
!define HELPURL "https://github.com/romansletr/mist/releases/issues"
!define UPDATEURL "https://github.com/romansletr/mist/releases"
!define ABOUTURL "https://victorium.org"
...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\Victorium"
...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "Geth incoming peers (TCP:30322)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "Victorium" 30322 "" "" ""
    #SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30322)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "Victorium" "" 30322 "" ""
    #SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30322)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "Victorium" "" 30322 "" ""
